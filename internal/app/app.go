...
func (a *App) setupServices() {
	...
	a.Services.QuestionService = service.NewQuestionService(a.Repositories.QuestionRepo, a.Repositories.SectionRepo, a.Services.GeminiService, a.Repositories.UserRepo)
